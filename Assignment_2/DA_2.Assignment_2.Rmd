...
data$highly_rate <- ifelse(data$rated>=4, 1, 0)
```
...
- Removed duplicates
- Removed Null values from _rating_
...
datasummary( price + lnprice + distance + stars + rating ~ Mean + SD + Min + Max + Median + P95 + N , data = data )
