...
For this assignement we use Hotels-Europe data. This data set contains two tables **[Features](https://osf.io/utwjs/download)** and **[Price](https://osf.io/p6tyr/download)**. We joined the two tables using left join. For the further analysis, we selected _**Paris**_ City and considered _**Hotels**_ as accomodation type. 
